...
def escena_project():
    ...
    #Cargamos el fondo
    tbg = Texture('./Proyecto1/texturebg.bmp')
    MyRender.framebuffer = tbg.pixels
    
    #Cargamos las máscaras
    t1=Texture('./Proyecto1/Mask2Texture.bmp')
    MyRender.display_obj('./Proyecto1/Mask2.obj', translate=(0, 0.6, 0), scale=(3, 3, 5),rotate=(0,0,0), texture=t1)
    
    t2=Texture('./Proyecto1/Mask1Texture.bmp')
    MyRender.display_obj('./Proyecto1/Mask1.obj', translate=(-0.6, 0.4, 0), scale=(3, 3, 5),rotate=(0,0,0), texture=t2)
    
    t3=Texture('./Proyecto1/Mask3Texture.bmp')
    MyRender.display_obj('./Proyecto1/Mask3.obj', translate=(0.5, 0.07, 0), scale=(1.5, 1.5, 2.5),rotate=(0,pi/9,0), texture=t3)
    
    #Cargamos el mueble
    t4=Texture('./Proyecto1/old_rustic_stand_Mat_BaseColor.bmp')
    MyRender.display_obj('./Proyecto1/old_rustic_stand.obj', translate=(0, -0.88, 0), scale=(0.7, 0.7, 0.7),rotate=(0,pi,0), texture=t4)
    
    # #Cargamos la planta
    t5=Texture('./Proyecto1/b3.bmp')
    MyRender.display_obj('./Proyecto1/Pot.obj', translate=(0, -0.2, 0), scale=(0.1, 0.1, 0.1),rotate=(0,0,0), texture=t5)
    
    #Testeamos la llegada a la escritura
